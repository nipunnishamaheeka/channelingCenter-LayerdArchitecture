...
@Override
    public boolean save(final Patient dto) throws SQLException{
...
@Override
    public boolean update(final Patient dto) throws SQLException{
...
@Override
    public Patient search(String id) throws SQLException{
        ...
        if (resultSet.next()) {
            ...
            dto = new Patient(Patient_id, Patient_name, Mobile_number, Address, Sex, Email, Age, Blood);
        }
...
@Override
    public List<Patient> getAll() throws SQLException{
        ...
        while (resultSet.next()) {
            ...
            var dto = new Patient(Patient_id, Patient_name, Mobile_number, Address, Sex, Email, Age, Blood);
            dtoList.add(dto);
        }
        return dtoList;
    }
...
@Override
    public Patient getDetailByContact(String contact) throws SQLException{
